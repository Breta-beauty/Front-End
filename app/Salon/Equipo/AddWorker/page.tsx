        ...
        <>
            ...
            <div className='flex flex-col items-center justify-center'> 
                ...
                <div className="w-[30%] shadow-lg shadow-breta-shadow rounded-lg ">
                    ...
                    <div className='flex items-center justify-center gap-4 mb-4'>
                        <input
                          ...
                          value={commission}
                          ></input>
                          <select className='w-1/2 text-sm ring-1 ring-gray-300 rounded-md p-2 bg-breta-light-gray focus:outline-0 placeholder:text-sm tracking-wider text-breta-dark-gray'
                                value={paymentCycle}
                                onChange={handlePaymentCycleChange}
                        >
                            <option className='text-breta-dark-gray'>Selecciona...</option>
                            <option className='text-breta-dark-gray' value="Semanal">Semanal</option>
                            <option className='text-breta-dark-gray' value="Catorcenal">Catorcenal</option>
                            <option className='text-breta-dark-gray' value="Quincenal">Quincenal</option>
                            <option className='text-breta-dark-gray' value="Mensual">Mensual</option>
                        </select>
                        <input
                          required
                    ...
                    <div className='flex items-center justify-center mb-4'>
                        <select className='w-[90%] text-sm ring-1 ring-gray-300 rounded-md p-2 bg-breta-light-gray focus:outline-0 placeholder:text-sm tracking-wider text-breta-dark-gray'
                                ...
                                >
                            <option className='text-breta-dark-gray' value="">Selecciona un rol...</option>
                ...
                <div className='flex w-[30%] items-center justify-center mt-5 mb-5'>
                    <button className='w-full h-12 bg-breta-blue rounded-lg text-[20px] text-white'
                            onClick={(e) => createEmployee(
                                                profile_picture,
                                                employee_name,
                                                cellphone,
                                                email,
